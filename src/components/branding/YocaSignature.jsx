/**
 * YocaSignature — official Yoca footer signature (JS build of the packaged
 * YocaSignature.tsx; TypeScript annotations removed, nothing else changed).
 * Source package: yoca-signature/ · docs: README.md / INTEGRATE.md
 */
...
function buildHref(campaign, source) {
